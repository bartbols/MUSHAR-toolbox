% This demo script will rigidly align a collection of muscle shapes and
...
figure('Color','w','Name','Shapes before and after alignment')
...
save(fullfile(dataFolder,'distmap','dimensions.mat'),'padding','voxelsize');
% ----------------------------------------------------------------------
...
figure('Name','Example distance map')
imagesc(D.img(:,:,round(size(D.img,3)/2)),[-1 1]*15)
